...
public class Bitwise {
    ...
    public static boolean isset(int i, byte bytes[]) {
    	int byte_num=i/8;
    	int byte_loca=i%8;
    	return isset(byte_loca,bytes[byte_num]);
    }
    ...
    public static void set(int i, byte bytes[]) {
    	int byte_num=i/8;
    	int byte_loca=i%8;
    	bytes[byte_num]=set(byte_loca,bytes[byte_num]);
    }
    ...
    public static boolean clear(int i, byte bytes[]) {
    	int byte_num=i/8;
    	int byte_loca=i%8;
    	boolean state=isset(i,bytes);
    	bytes[byte_num]=clear(byte_loca,bytes[byte_num]);
    	return state;
    }
